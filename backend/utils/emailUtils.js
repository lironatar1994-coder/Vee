...
<body style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: #f3f4f6; margin: 0; padding: 0; direction: rtl;">
    <div style="max-width: 600px; margin: 40px auto; background-color: #ffffff; border-radius: 24px; overflow: hidden; box-shadow: 0 10px 25px rgba(0,0,0,0.05);">
        ...
        <div style="background: linear-gradient(135deg, #6366f1 0%, #4f46e5 100%); padding: 40px 30px; text-align: center;">
            ...
            <h1 style="color: #ffffff; margin: 0; font-size: 28px; font-weight: 800;">בקשה לאיפוס סיסמה</h1>
        </div>
        
        <!-- Content -->
        <div style="padding: 40px 30px; text-align: center;">
            <p style="font-size: 18px; color: #374151; line-height: 1.6; margin-bottom: 30px;">
                קיבלנו בקשה לאיפוס הסיסמה שלך ב-Vee. אם לא ביקשת זאת, ניתן להתעלם מהודעה זו.
            </p>
            
            <div style="background-color: #f8fafc; border: 1px dashed #cbd5e1; border-radius: 12px; padding: 20px; margin-bottom: 30px;">
                 <p style="margin: 0; color: #64748b; font-size: 15px;">הקישור הזה תקף ל-15 דקות בלבד.</p>
            </div>

            <a href="${resetLink}" style="display: inline-block; background: #6366f1; color: #ffffff; text-decoration: none; padding: 16px 40px; border-radius: 50px; font-weight: bold; font-size: 18px; box-shadow: 0 4px 15px rgba(99, 102, 241, 0.4); transition: transform 0.2s;">
                איפוס סיסמה עכשיו
            </a>
